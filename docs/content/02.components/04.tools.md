...
```tsx [React]
<TdtPolylineTool active={lineActive} color="#f97316" onDraw={(e) => console.log(e.currentDistance)} />
```
...
```tsx [React]
<TdtPolygonTool active={areaActive} fillColor="#f97316" onDraw={(e) => console.log(e.currentArea)} />
```
...
```tsx [React]
<TdtCircleTool active={circleActive} onDraw={(e) => console.log(e.currentRadius)} />
<TdtRectangleTool active={rectActive} onDraw={(e) => console.log(e.currentBounds)} />
```
...
```tsx [React]
<TdtMarkTool active={markActive} onMouseup={(e) => console.log(e.lnglat, e.marker)} />
```
...
```tsx [React]
<TdtCoordinatePickup active={pickupActive} onPick={(lnglat) => console.log(lnglat.lng, lnglat.lat)} />
```
